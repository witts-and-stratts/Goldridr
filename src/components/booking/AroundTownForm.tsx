...
interface AroundTownFormProps {
  onBack: () => void;
}

export function AroundTownForm( { onBack }: AroundTownFormProps ) {
  return (
    <motion.div
    ...
    >
      <div className="mb-8 flex items-center gap-4">
        ...
        <div>
          <h3 className="font-serif text-2xl text-white">Around Town</h3>
          <p className="font-sans text-sm font-light text-gray-400">
            Point-to-point service within the city
          </p>
        </div>
      </div>
