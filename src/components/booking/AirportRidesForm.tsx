...
interface AirportRidesFormProps {
  onBack: () => void;
}

export function AirportRidesForm( { onBack }: AirportRidesFormProps ) {
  return (
    <motion.div
    ...
    >
      <div className="mb-8 flex items-center gap-4">
        ...
        <div>
          <h3 className="font-serif text-2xl text-white">Airport Transfer</h3>
          <p className="font-sans text-sm font-light text-gray-400">
            Enter your flight details for a seamless pickup
          </p>
        </div>
      </div>
      ...
      <form className="space-y-6" onSubmit={ ( e ) => e.preventDefault() }>
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="space-y-2">
            <label className="text-xs uppercase tracking-widest text-[#D4AF37]">Dropoff Location</label>
            <input
              type="text"
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="space-y-2">
            <label className="text-xs uppercase tracking-widest text-[#D4AF37]">Flight Number</label>
            <input
              type="text"
